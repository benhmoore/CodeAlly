...
def test_file_hash_management(token_manager):
    ...
    previous_id = token_manager.register_file_read(file_path, new_content, new_message_id)
    ...
    result = token_manager.get_existing_file_message_id("/non/existent/file.py", "content")
